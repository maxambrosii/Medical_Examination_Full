    ...
    public partial class GeneralForm : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (panelOpenDelete == false)
            {
                ...
                bunifuTransitionHorizontal.Hide(panelDELETE);
            ...
            if (panelOpenUpdate == false)
            {
                ...
                bunifuTransitionHorizontal.Hide(panelUPDATE);
                panelOpenUpdate = true;
            }
            if (panelOpenAdd == false)
            {
                bunifuTransitionHorizontal.Hide(panelADD);
                panelOpenAdd = true;
            }

            if (panelOpenRedact == false)
            {
                bunifuTransitionHorizontal.Hide(panelREDACT);
            ...
            {
                bunifuTransitionHorizontal.Hide(panelView1);
                panelOpenView1 = true;
            }
            if (panelOpenView == false)
            {
                bunifuTransitionHorizontal.Hide(panelView);
                panelOpenView = true;
            }
            ...
            {
                bunifuTransitionHorizontal.Hide(panelProperties);
                panelOpenPrefer = true;
            }

            if (panelOpenHelp == false)
            {
                bunifuTransitionHorizontal.Hide(panelHelp);
                panelOpenHelp = true;
            }

            if (panelOpen == false)
            {    
              pictureBoxMenu.Image = Properties.Resources.rotateMenu;
              bunifuTransitionHorizontal.Show(panel1);
                panelOpen = true;
            }
            else
            {
                pictureBoxMenu.Image = Properties.Resources.menu_icon_5;
                bunifuTransitionHorizontal.Hide(panel1);
                panelOpen = false;
            }
        ...
        private void label1_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelREDACT);
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelHelp);
                panelOpenHelp = false;
            }
            else
            {
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelProperties);
        ...
        private void label4_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelView);
                panelOpenView = false;
            }
            else
            {
        ...
        private void label21_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelView1);
        ...
        private void label8_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelADD);
                panelOpenAdd = false;
            }
            else
            {
        ...
        private void label5_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelUPDATE);
        ...
        private void label7_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuTransitionHorizontal.Show(panelDELETE);
        ...
        private void pictureBox31_Click_1(object sender, EventArgs e)
        {
            if (OpenFull == false)
            {
                ...
                OpenFull = true;
                IconMaximize.Image = Properties.Resources.Svernuti;
            }
            else
            {
                ...
                this.Width = 856;
                this.Height = 602;
                IconMaximize.Image = Properties.Resources.Razvernuti;
                OpenFull = false;
            }
        }
        ...
        private void label24_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Loader2 scanGetCountPacientByAreaForm = new Loader2();
                scanGetCountPacientByAreaForm.ShowDialog();
                scanGetCountPacientByAreaForm = null;
                this.Show();
